...
# TODO: compute the number of genes or entities already curated by ClinGen or other sources (GenCC)
clingen_genes <- "XXX"
...
# join the merge_analyses_sources and DiagnosticPanels_genes tables and filter for evidence_count >= 3
