...
# TODO: also for other numbers with placeholders
# TODO: version the files with the date
...
# TODO: create folder if not existent
# TODO: replace merged_sources in raw file, add to replacement list
replace_strings("static/img/figures/raw/curation_flow_diagram_raw.drawio",
    ...
    c("HIGHEVIDENCE_GENES", "CLINGEN_GENES", "MANUALSCORING_GENES"),
    c(high_evidence_genes, clingen_genes, manualscoring_genes))
```
