...
iframe(width = "1067", height = "600", url_link = "static/img/visualizations/Kidney-Genetics_AG Halbritter_20231205.html")
```
...
```{r, echo=FALSE, warning=FALSE, out.width = "100%"}
iframe(width = "1067", height = "600", url_link = "static/img/visualizations/Kidney-Genetics_DGfN_20231007.html")
```
...
```{r, echo=FALSE, warning=FALSE, out.width = "100%"}
iframe(width = "1067", height = "600", url_link = "static/img/visualizations/Kidney-Genetics_AG-Halbritter_20230705.html")
```
...
```{r, echo=FALSE, warning=FALSE, out.width = "100%"}
iframe(width = "600", height = "849", url_link = "static/img/visualizations/Kidney-Genetics_MRC Symposium_20230928.html")
```